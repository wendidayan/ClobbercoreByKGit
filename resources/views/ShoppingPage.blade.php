...
<body style="background: #f5f5f5;">
        ...
        <div class="review-card mt-4 p-4" style="border-radius:8px;border:1px solid rgba(173,181,189,0.6);">
            <div class="review-details">
                <div class="d-flex align-items-xxl-center review-info gap-3">
                    <img class="object-fit-cover review-profile" alt="Profile image" style="border-radius:50%;width:50px;height:50px;" src="assets/img/photo-1517841905240-472988babdf9.jpg">
    ...
    <div id="chatbox" class="chatbox-popup">
        <input type="hidden" id="current-user-id" value="{{ Auth::guard('web')->user()->id }}">
        <input type="hidden" id="current-user-type" value="App\Models\User">
        <input type="hidden" id="receiver-id" value="">
        <input type="hidden" id="receiver-type" value="">
        <!-- ... rest of the chat container code ... -->

        <script>
            console.log("CurrentUserId =", document.getElementById('current-user-id').value);
            console.log("CurrentUserType =", document.getElementById('current-user-type').value);
        </script>
    </div>
