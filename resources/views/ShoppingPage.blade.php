                ...
                <div class="container-fluid"><a class="navbar-brand" href="#" style="color: var(--bs-gray-900);--bs-body-font-weight: normal;font-weight: bold;">Clobbercore by K</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse d-md-flex justify-content-md-center justify-content-lg-end me-0 pe-0 ms-0" id="navcol-1">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="PlaceOrder.html" style="font-size: 13px;">MY CART&nbsp;<span>(5)</span></a></li>
                        </ul>
                        <ul class="navbar-nav ms-auto">
            ...
            <div class="container mt-0 pt-0">
                <section class="photo-gallery py-4 py-xl-5 mt-0 pt-4" style="padding: 50px 0px;">
                    <div class="container" style="font-family:'Open Sans', sans-serif;padding:0px;">
                        <div class="row gx-2 gy-2 row-cols-1 row-cols-md-2 text-center d-xxl-flex justify-content-xxl-center photos row-cols-xl-6" data-bss-baguettebox="">
    ...
    <section id="categories" class="mt-5" style="font-family: 'Open Sans', sans-serif;">
        <div class="new-arrival-heading" style="font-family: 'Open Sans', sans-serif;">
            ...
            <div class="container mt-0 pt-0">
                <section class="photo-gallery py-4 py-xl-5 mt-0 pt-4" style="padding: 50px 0px;">
                    <div class="container" style="font-family: 'Open Sans', sans-serif;padding: 0px;">
                        <div class="row gx-2 gy-2 row-cols-1 row-cols-md-2 photos row-cols-xl-6" data-bss-baguettebox="">
                            <div class="col item">
                                <div class="card">
                            ...
                            <div class="col item">
                                <div class="card">
                                    <div class="card-body"><img class="img-fluid" src="assets/img/5.png">
                                        <h4 class="card-title" style="font-size: 16px;margin-top: 12px;text-align: center;">Women's Shirt</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col item">
                                <div class="card">
                                    <div class="card-body"><img class="img-fluid" src="assets/img/4.png">
                                        <h4 class="card-title" style="font-size: 16px;margin-top: 12px;text-align: center;">Women's Pants</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col item">
                                <div class="card">
                                    <div class="card-body"><img class="img-fluid" src="assets/img/7.png">
                                        <h4 class="card-title" style="font-size: 16px;margin-top: 12px;text-align: center;">Dress</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col item">
                                <div class="card">
                                    <div class="card-body"><img class="img-fluid" src="assets/img/3.png">
                                        <h4 class="card-title" style="font-size: 16px;margin-top: 12px;text-align: center;">Denim Short</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col item">
                                <div class="card">
                                    <div class="card-body"><img class="img-fluid" src="assets/img/2.png">
                                        <h4 class="card-title" style="font-size: 16px;margin-top: 12px;text-align: center;">Kidswear</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
